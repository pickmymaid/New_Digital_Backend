 ...
 * database.
 * @param {object} body - The blog data being passed to the function. It contains the
 ...
 * @param {object} body - The `body` parameter contains the
 ...
 */
const editBlog = async (slug, body, thumbnailFile) => {
    const updateData = {
 ...
 */
const getAllBlogsPaginated = async (page) => {
 ...
 */
const getBlogById = async (slug, user_id) => {
 ...
 */
const likeBlog = async (slug, user_id) => {
...
const deleteCommentId = async (slug, comment_id) => {
    const response = await BlogModel.updateOne({slug},{
        $pull:{
            comments: {
                _id: comment_id
