const { generateDatetime } = require("../generateDatetime");
const { experienceCalculator } = require("../maids/experienceCalculator");

const promotionalMailBody = (maids, email) => `
<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
...
module.exports = { promotionalMailBody };
